...
VALUES
    (900000000000001022, '合同管理', 'menu:contract-management', 1, 0, '/contract-management', 0),
    (900000000000001023, '项目归档', 'menu:project-archive', 1, 0, '/project-archive', 0)
