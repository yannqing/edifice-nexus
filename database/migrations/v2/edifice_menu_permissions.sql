...
VALUES
    (900001000, 0, '', 'edifice 工程管理', 'edifice', 'edifice', 'icon-jichupeizhi', 1, 900, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001001, 900001000, '/', '工作台', 'edifice:menu:workbench', 'edifice', '', 1, 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001002, 900001000, '/my-projects', '我的项目', 'edifice:menu:my-projects', 'edifice', '', 1, 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001003, 900001000, '/inspection-approval', '验工审批', 'edifice:menu:inspection-approval', 'edifice', '', 1, 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001004, 900001000, '/timesheet', '工时填报', 'edifice:menu:timesheet', 'edifice', '', 1, 4, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001005, 900001000, '/oa/applications', 'OA 申请', 'edifice:menu:oa-applications', 'edifice', '', 1, 5, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001006, 900001000, '/all-projects', '全部项目', 'edifice:menu:all-projects', 'edifice', '', 1, 6, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001007, 900001000, '/inspection-management', '验工单管理', 'edifice:menu:inspection-management', 'edifice', '', 1, 7, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001008, 900001000, '/project-files/approval', '项目文件审批', 'edifice:menu:project-files-approval', 'edifice', '', 1, 8, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001009, 900001000, '/bids', '投标管理', 'edifice:menu:bids', 'edifice', '', 1, 9, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001010, 900001000, '/output-value', '产值分配', 'edifice:menu:output-value', 'edifice', '', 1, 10, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001011, 900001000, '/collection', '回款记录', 'edifice:menu:collection', 'edifice', '', 1, 11, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001012, 900001000, '/statistics', '统计报表', 'edifice:menu:statistics', 'edifice', '', 1, 12, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001013, 900001000, '/performance', '个人绩效', 'edifice:menu:performance', 'edifice', '', 1, 13, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001014, 900001000, '/reports/personnel-quarter', '人员分配汇总', 'edifice:menu:personnel-quarter', 'edifice', '', 1, 14, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001015, 900001000, '/user-management', '用户管理', 'edifice:menu:user-management', 'edifice', '', 1, 15, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
    (900001016, 900001000, '/announcement-management', '公告管理', 'edifice:menu:announcement-management', 'edifice', '', 1, 16, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
ON DUPLICATE KEY UPDATE
    pid = VALUES(pid),
    src = VALUES(src),
    title = VALUES(title),
