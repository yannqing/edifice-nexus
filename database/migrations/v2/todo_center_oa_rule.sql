...
VALUES
    ...
    (900001019, 900001000, '/todo-center', '统一待办', 'edifice:menu:todo-center', 'edifice', '', 0, 19, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())
...
UPDATE oa_admin_group
SET rules = TRIM(BOTH ',' FROM CONCAT_WS(',', NULLIF(TRIM(BOTH ',' FROM rules), ''), '900001019'))
WHERE FIND_IN_SET('900001019', rules) = 0;
